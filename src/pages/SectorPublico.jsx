    ...
    <div className="bg-bg">
      ...
      <section className="relative px-4 hero-gradient noise-overlay overflow-x-clip py-16 md:py-24">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <div className="mt-10 flex flex-wrap gap-2 justify-center">
            ...
            <a
              href="#roles"
              className="inline-flex items-center gap-2 bg-text text-bg px-5 py-2.5 rounded-xl font-semibold no-underline hover:bg-text/90 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-sm"
            >
      ...
      <section id="roles" className="relative max-w-6xl mx-auto px-4 py-14 scroll-mt-20 overflow-hidden">
        ...
        <div className="relative text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-text text-bg px-4 py-1.5 rounded-full text-xs font-semibold mb-4 shadow-md">
          ...
          {PROMPTS_LIBRARY.map((r) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold border transition-all ${isActive ? 'bg-text text-bg border-text shadow-md scale-[1.03]' : 'bg-surface text-text-light border-border hover:border-primary/40 hover:text-primary'}`}
              >
          ...
          {qIndex === -1 && !testComplete && (
            <div className="bg-surface border border-border rounded-3xl p-8 md:p-10 shadow-lg text-center">
              ...
              <button
                type="button"
                onClick={() => setQIndex(0)}
                className="inline-flex items-center gap-2 bg-text text-bg px-7 py-3.5 rounded-xl font-semibold hover:bg-text/90 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-sm"
              >
            ...
            <div className="bg-surface border border-border rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="p-7 md:p-9">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-border">
                  ...
                  <a
                    href="#prompts"
                    className="inline-flex items-center justify-center gap-2 bg-text text-bg px-5 py-2.5 rounded-xl font-semibold hover:bg-text/90 hover:shadow-lg transition-all text-sm"
                  >
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        <div className="bg-text text-bg rounded-2xl p-6 md:p-10">
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            to="/explorar"
            className="inline-flex items-center gap-2 bg-text text-bg px-6 py-3.5 rounded-xl font-semibold no-underline hover:bg-text/90 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 text-sm"
          >
