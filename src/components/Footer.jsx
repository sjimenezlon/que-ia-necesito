          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-text-lighter text-xs mt-0.5">
                Última actualización: Julio 2026 · <a href="https://sjimenezlon.co/" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 no-underline">sjimenezlon.co</a>
              </p>
            </div>
          </div>
