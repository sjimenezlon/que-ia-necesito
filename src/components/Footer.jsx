  ...
  return (
    <footer className="border-t border-border mt-20 bg-surface relative">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border pb-6 mb-7">
          <div>
            <h2 className="text-lg font-semibold">¿A quién le serviría esta guía?</h2>
            <p className="text-sm text-text-light mt-1">
              Compártela para que más personas encuentren por dónde empezar.
            </p>
          </div>
          <ShareLink label="Compartir queianecesitas.dev" />
        </div>
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-text-lighter text-xs mt-0.5">
                Actualización editorial: <time dateTime="2026-09-14">14 de septiembre de 2026</time> ·{' '}
                <a
                  href="https://sjimenezlon.co/"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="text-text-lighter text-xs text-center md:text-right max-w-sm leading-relaxed space-y-1.5">
            <p>
              Esta guía es orientativa. Verifica siempre los precios y funcionalidades en los sitios
              oficiales.
            </p>
